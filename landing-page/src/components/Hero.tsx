    ...
    <section style={{
      ...
      <div style={{
        ...
        <div style={{ flex: 1, maxWidth: 560 }}>
          ...
          >
            <a href="https://github.com/mostafaarihani-debug/CachePilot/releases/download/v1.1.10/CachePilot-Setup-1.1.10.exe" className="btn-primary" style={{ fontSize: 16, padding: '16px 32px' }}>
